...
public class Principal extends JFrame {
	...
	public Principal() {
		...
		imagenFondo.setIcon(new ImageIcon(Principal.class.getResource("/imagenes/menu-img.png")));
		panel.add(imagenFondo);

		JLabel logo = new JLabel("");
		logo.setBounds(722, 80, 150, 156);
		logo.setIcon(new ImageIcon(Principal.class.getResource("/imagenes/aH-150px.png")));
		panel.add(logo);
		...
		JLabel lblCopyR = new JLabel("Desarrollado por EBlanco © 2023");
		...
		imagenLogin.setIcon(new ImageIcon(Principal.class.getResource("/imagenes/login.png")));
